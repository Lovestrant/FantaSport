...
<div class = "row"  id="headerbody">
    ...
    <div class="row">
    <div class="col-sm-12">
            <p id="topparagraph" style="font-size: 25px">Admin Login:</p>
        </div>
    </div>
    <br><br>
    ...
    <div class="col-sm-12" id="topparagraph">
            <form action="loginadmin.php" method="post">
                <input class="reginput" type="email" name ="email" placeholder="Enter Admin Email" value="<?php echo $email;?>"><br><br>
                <input  class="passinput" type="password" name = "password" placeholder ="Enter Admin password" value="<?php echo $password;?>"> <br><br>
